...
@ActiveProfiles(PROD_PROFILE)
@SpringBootTest
@AutoConfigureMockMvc
public class HomeControllerProdProfileTest {
    ...
    public void shouldReturnFooMsgForDevProfile() throws Exception {
        this.mockMvc.perform(get("/foo"))
                ...
                .andExpect(content().string("An example foo value - prod profile"));
    }
    ...
    public void shouldReturnBarMsgForDevProfile() throws Exception {
        this.mockMvc.perform(get("/bar"))
                .andExpect(status().isOk())
                .andExpect(content().string("An example bar value - prod profile"));
    }
